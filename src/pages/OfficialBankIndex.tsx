...
const OfficialBankIndex = () => {
  ...
  const getQuestionProgress = useCallback((q: BankQuestion, subject: BankSubject): QuestionProgress => {
    // UPDATED KEY PREFIX to separate official bank progress
    const key = `official-bank-${subject}-${q.sourceId}`;
  ...
  const startPracticeSession = useCallback((questions: BankQuestion[]) => {
    ...
    const practiceSet = questions.map((q, index) => ({
      ...
      // Flag to indicate this is an official bank practice session, for navigation component
      isOfficial: true, 
    }));
    sessionStorage.setItem('officialPracticeSet', JSON.stringify(practiceSet)); // Use different key
      ...
      <section className="container mx-auto px-4 pt-8 pb-12">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">Official Question Bank</h1>
...
export default OfficialBankIndex;
