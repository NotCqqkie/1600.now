  ...
  return (
    <div ref={handleQuestionRootRef} className={cn("bg-background flex flex-col relative", isEmbed ? (isNativeEmbed ? "h-full min-h-full overflow-hidden" : "h-screen overflow-hidden") : "min-h-screen")}>
      ...
      {isIdleTimerPromptOpen && (
        <div className={cn(isNativeEmbed ? "absolute" : "fixed", "inset-0 z-[90] flex items-center justify-center bg-background/45 p-3 backdrop-blur-[2px] sm:p-6")}>
          <div
            role="dialog"
            aria-modal="true"
