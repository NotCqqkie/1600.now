...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It compares two distinct methods of analyzing genomic data, then explains why the second method is relatively underused."
      },
      {
        "id": "B",
        "text": "It describes two different approaches used by researchers, then emphasizes how promising one of those approaches is."
      },
      {
        "id": "C",
        "text": "It summarizes previous research on a topic, then illustrates how a group of scientists used a new method to challenge findings produced by that research."
      },
      {
        "id": "D",
        "text": "It provides an overview of a technique traditionally used by scientists, then asserts that an alternative technique is superior to it."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It depicts the meeting of a group of Black theater professionals and then acknowledges the obstacles they faced in their attempts to establish a theater company."
      },
      {
        "id": "B",
        "text": "It outlines the similarities between two plays and then considers how these plays were important to the founding of a theater company."
      },
      {
        "id": "C",
        "text": "It refers to the production of a play and then examines the theater company responsible for that production."
      },
      {
        "id": "D",
        "text": "It summarizes the impact of two plays by Black playwrights and then details the history of the theater company that produced them."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "By arguing that Jones displays a thorough knowledge of historical details in *The Known World*."
      },
      {
        "id": "B",
        "text": "By claiming that the author of Text 1 has underestimated the richness and complexity of *The Known World*."
      },
      {
        "id": "C",
        "text": "By conceding that the genre of historical fiction contains many works that are less sophisticated than *The Known World* is."
      },
      {
        "id": "D",
        "text": "By asserting that dissatisfaction with describing *The Known World* as historical fiction reflects a misunderstanding of the genre."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "The plant life on Bosco Verticale ended up being less varied than Boeri had envisioned it would be."
      },
      {
        "id": "C",
        "text": "The construction of Bosco Verticale was no less environmentally damaging than the construction of more conventional buildings is."
      },
      {
        "id": "D",
        "text": "It is unclear whether Bosco Verticale can support the plant life included in its design."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "Medina-Alcaide and her team discovered that Paleolithic cave artists in Spain used animal-fat lamps more often than they used torches."
      },
      {
        "id": "C",
        "text": "Medina-Alcaide and her team were reluctant to draw many conclusions from their study because of the difficulty they had replicating light sources based on known artifacts."
      },
      {
        "id": "D",
        "text": "Medina-Alcaide and her team tested Paleolithic light sources and learned some details about how Paleolithic artists traveled within dark caves."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "ranged from 5.0 to 92.00, indicating that well-being varied widely from participant to participant."
      },
      {
        "id": "B",
        "text": "were lower for two measures, with the rating for only one measure indicating greater well-being for these participants."
      },
      {
        "id": "C",
        "text": "ranged from 3.9 to 46.00, with no rating indicating greater well-being in any measure for these participants."
      },
      {
        "id": "D",
        "text": "were higher for all three measures, indicating greater overall well-being for these participants."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Bartley is worried that Jack is unaware of the coming rain."
      },
      {
        "id": "B",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Although consumers were more likely to purchase complementary extended brands than substitutable extended brands, the difference in purchasing probability reduced to zero when tortilla chips and salsa were removed from consideration."
      },
      {
        "id": "B",
        "text": "Although consumers purchased complementary extended brands more frequently than substitutable extended brands, removing ultra-pasteurized milk and raw milk from the data led to an equal purchasing frequency of complementary and substitutable products."
      },
      {
        "id": "C",
        "text": "Although consumers were about equally likely to purchase complementary extended brands and substitutable extended brands, removing tortilla chips and salsa from the data increased the likelihood that consumers would purchase complementary extended brands."
      },
      {
        "id": "D",
        "text": "Although consumers purchased substitutable extended brands more often than complementary ones, the removal of ultra-pasteurized milk and raw milk from the data caused the two product types to be purchased at equal rates."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "speculations about the relative inability of democratic institutions to counteract inflation are based on measures that tend to exaggerate the levels of inflation in strongly democratic countries such as Norway."
      },
      {
        "id": "C",
        "text": "it would be a mistake to treat the relative inflation rates of Norway and Cameroon as indicative of an inherent shortcoming in democratic institutions with regard to control over inflation."
      },
      {
        "id": "D",
        "text": "the difference between Norway and Cameroon with regard to democratic institution strength may have been greater in 2016 than was represented by international indices."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "constitutions enacted in 1997;"
      },
      {
        "id": "B",
        "text": "constitutions, enacted in 1997;"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "Designed by Antonio Stradivari, Stradivarius violins in the Jules Falk are renowned for their quality."
      },
      {
        "id": "D",
