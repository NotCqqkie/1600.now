...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "The similarity between the pattern of brain activity a dog showed in response for hearing the scrambled recording and the pattern of brain activity it showed in response to hearing the language it was not accustomed to was greatest among older dogs."
      },
      {
        "id": "C",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Pajkowska sailed *FanFan* around the world, while Cremer sailed *Banque Populaire X*."
      },
      {
        "id": "B",
      ...
      {
        "id": "C",
        "text": "Pajkowska and Cremer have both embarked on sailing journeys around the world, also called circumnavigations."
      },
      {
        "id": "D",
