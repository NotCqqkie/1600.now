...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "To compare the Old Manse with other museums."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It explains how 3D vision in horses and toads differs from the type of 3D vision discussed in the text."
      },
      {
        "id": "B",
        "text": "It offers a suggestion for future research on the aspect of 3D vision discussed in the text."
      },
      {
        "id": "C",
        "text": "It presents the results of the study of 3D vision discussed in the text."
      },
      {
        "id": "D",
        "text": "It explains why the animals discussed in the text were once thought to lack 3D vision."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "They illustrate factors that researchers believe people consider when making walking decisions in most contexts but that the text argues are unique to walking decisions made by people in Boston."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Several famous Indigenous writers increased their book sales when they began incorporating traditional stories."
      },
      {
        "id": "B",
        "text": "Recent Indigenous fiction writers are mixing traditional stories with popular literary genres."
      },
      {
        "id": "C",
        "text": "The success of Darcie Little Badger has influenced non Indigenous authors who write in popular literary genres."
      },
      {
        "id": "D",
        "text": "Non Indigenous authors should consider the expectations of Indigenous readers."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "was greater than the contribution made by professional services but equal to that made by arts/entertainment/recreation."
      },
      {
        "id": "B",
        "text": "exceeded the contribution made by both arts/entertainment/recreation and professional services."
      },
      {
        "id": "C",
        "text": "was lower than the contribution made by either arts/entertainment/recreation or professional services."
      },
      {
        "id": "D",
        "text": "surpassed the contribution made by arts/entertainment/recreation but fell short of that made by professional services."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Individual 15 directed a higher proportion of peering events at immigrants to its home region than did individual 16, and individual 1 directed a higher proportion of peering events at immigrants to its home region than did individual 6."
      },
      {
        "id": "B",
        "text": "Individual 16 had the highest total number of peering events observed at 80."
      },
      {
        "id": "C",
        "text": "Individual 6 and individual 1 directed a lower proportion of peering events at immigrants to their home regions than did individual 15 and individual 16."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "companies in Thailand experienced a greater increase in investment following liberalization than did companies in Malaysia."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "*Rotate* a large metal sculpture by artist Richard Serra stretches roughly 6 feet wide and 12 feet tall."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "The traditional approach to dyeing blue jeans is to dip them in a solution containing hazardous chemicals."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "Spreading out from the focus of an earthquake, P waves move the ground backward and forward."
      },
      {
        "id": "D",
        "text": "Although P waves and S waves start at the same point, they behave very differently."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "Countries sometimes adopt new currency systems, as the Gambia did when it replaced the Gambian pound with the dalasi."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
