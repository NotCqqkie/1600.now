...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "It helps explain why some people are especially perceptive of the social dynamics at theaters."
      },
      {
        "id": "C",
        "text": "It emphasizes a character's dedication to her career."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "To portray Louis Pipestone's strong commitment to collecting signatures for the petition"
      },
      {
        "id": "D",
        "text": "To suggest that some tribal members refuse to sign the petition because they dislike Louis Pipestone"
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "How many other plural versions of the pronoun \"you\" are there in English, besides \"y'all\"?"
      },
      {
        "id": "B",
        "text": "When was the first recorded use of the pronoun \"y'all\" in the English language?"
      },
      {
        "id": "C",
        "text": "Is \"y'all\" commonly used in English-speaking regions of the world besides the US?"
      },
      {
        "id": "D",
        "text": "Why has the pronoun \"y'all\" become more widely used in the US?"
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It is the subject of great debate among legal experts."
      },
      {
        "id": "B",
        "text": "It once referred to a specific product made by a particular company."
      },
      {
        "id": "C",
        "text": "It has recently become surprisingly popular for unknown reasons."
      },
      {
        "id": "D",
        "text": "It was never intended by its creator to be used as a trademark."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Many people who have been to Savannah say that the SCAD Museum of Art is worth visiting."
      },
      {
        "id": "B",
        "text": "Each year, more people access the online image of The Card Game than visit the SCAD Museum of Art in person."
      },
      {
        "id": "C",
        "text": "The SCAD Museum of Art has several works by Jacob Lawrence."
      },
      {
        "id": "D",
        "text": "The Card Game has been praised by some art critics."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "Lake Neusiedl, which had more days of ice in the winter of 2005-06 than it did in the winter of 1980-81."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "When participants were asked to identify the correct version of the Bic logo, 65.3% selected the unaltered image."
      },
      {
        "id": "B",
        "text": "Participants were asked to identify the correct version of the Bic logo, which contains a cartoon man holding a pen."
      },
      {
        "id": "C",
        "text": "The Bic logo contains a cartoon man holding a pen, but in one of the altered versions, the man was holding a pencil."
      },
      {
        "id": "D",
        "text": "In a 2021 study, researchers asked participants to identify the correct version of the Bic logo."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Musicians Mark Wood and Bill Hudson both toured with the genre-bending band TSO."
      },
      {
        "id": "B",
        "text": "It was from 1999 to 2008 that electric violinist Mark Wood performed with TSO."
      },
      {
        "id": "C",
        "text": "From electric violinist Mark Wood to guitarist Bill Hudson, musicians of all backgrounds have taken the opportunity to perform with TSO."
      },
      {
        "id": "D",
        "text": "From 1999 to 2008, Mark Wood performed with TSO as a touring electric violinist."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
