...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "A. It lists several traits of Scyliorhinus canicula discovered by Green and Jutfelt while conducting their 2014 study."
      },
      {
        "id": "B",
        "text": "It emphasizes a detail about where Green and Jutfelt conducted their 2014 study."
      },
      {
        "id": "C",
        "text": "It presents a criticism of the results reported by Green and Jutfelt in their 2014 study."
      },
      {
        "id": "D",
        "text": "It states the conclusion reached by Green and Jutfelt in their 2014 study."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It draws a distinction between the two species discussed in the text."
      },
      {
        "id": "B",
        "text": "It signals the surprising nature of the findings discussed in the text."
      },
      {
        "id": "C",
        "text": "It clarifies a potential point of confusion about the hypothesis tested in the study discussed in the text."
      },
      {
        "id": "D",
        "text": "It acknowledges that readers may object to the method used in the experiment discussed in the text."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "He has received much praise but tends to overestimate influential people's respect for him."
      },
      {
        "id": "C",
        "text": "He seeks mainly the admiration of readers in places that are far away."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Agaricia fragilis, because its minimum depth of 10 meters is in the shallow zone."
      },
      {
        "id": "B",
        "text": "Cycloseris tenuis, because its minimum depth of 1 meter is the shallowest of those listed."
      },
      {
        "id": "C",
      ...
      {
        "id": "D",
        "text": "Acropora caroliniana, because its maximum depth of 25 meters is close to but doesn't reach the mesophotic zone."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Johnson is a North Carolina photographer, as were all of the artists featured in Across County Lines."
      },
      {
        "id": "B",
        "text": "The Nasher Museum has a world-class collection of contemporary art that includes many paintings and textile pieces from artists both inside and outside North Carolina."
      },
      {
        "id": "C",
        "text": "McIver is a painter, Johnson is a photographer, and Cartwright is a textile artist."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "additional research is needed with participants from countries of varying level of economic development to determine whether delivery time and tracking are more important than package design to customers broadly."
      },
      {
        "id": "C",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "University, George Akerlof,"
      },
      {
        "id": "B",
        "text": "University George Akerlof,"
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Calcite has a Mohs scale number of 3, which means that it is harder than talc (1) but softer than orthoclase (6)."
      },
      {
        "id": "B",
        "text": "In the Mohs scale of mineral hardness, orthoclase (6) is ranked higher than talc (1)."
      },
      {
        "id": "C",
        "text": "Orthoclase, which has a Mohs scale number of 6, can scratch both talc and calcite."
      },
      {
        "id": "D",
        "text": "Calcite, talc, and orthoclase can be ordered by their ability to leave visible scratches on other minerals."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "The US has designated more than 500 areas NWRs, including the Bear Valley NWR in Oregon."
      },
      {
        "id": "B",
      ...
      {
        "id": "C",
        "text": "While the Bear Valley NWR extends across a 4,200-acre area, the Moapa Valley NWR encompasses only 32 acres."
      },
      {
        "id": "D",
        "text": "Both the Bear Valley NWR and the Moapa Valley NWR were established to protect endangered species."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "India Arie is an African American singer and songwriter whose music has been described as a blend of hip hop, soul and folk [that is] as subtle as it [is] inspired."
      },
      {
        "id": "B",
