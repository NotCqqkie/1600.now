...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "demarcated from"
      },
      {
        "id": "B",
        "text": "reconstituted as"
      },
      {
        "id": "C",
        "text": "derived from"
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It accounts for a writer's lack of popular appeal, cites a literary figure who appreciates that writer, and summarizes the qualities that make the writer's work unique."
      },
      {
        "id": "B",
        "text": "It describes a writer's successful career, presents two literary figures who were supporters of that writer's career, and explains why the writer was able to achieve what he did."
      },
      {
        "id": "C",
        "text": "It mentions a writer whose work is not widely known, presents two people who hold a positive opinion of that writer, and gives a reason why one of those people holds that opinion."
      },
      {
        "id": "D",
        "text": "It identifies a writer whose work is regarded as difficult to read, brings up two admirers of that writer's work, and gives information that may make the writer's work more accessible to new readers."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "They illustrate factors that researchers believe people consider when making walking decisions in most contexts but that the text argues are unique to walking decisions made by people in Lisbon."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "The Naked Sun is more representative of Asimov's writing style than Foundation is."
      },
      {
        "id": "B",
        "text": "Asimov's writing style is often unfairly criticized."
      },
      {
        "id": "C",
        "text": "Asimov's characters can be concerned mainly with intellectual matters rather than emotions."
      },
      {
        "id": "D",
        "text": "Asimov was correct to suggest that individual humans have little influence over the course of human history."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Although people seek to be viewed as virtuous, the most insignificant setbacks will often inhibit them from being so."
      },
      {
        "id": "B",
        "text": "People tend to fixate more often than they should on whether their acquaintances think highly of them."
      },
      {
        "id": "C",
        "text": "People are better off not knowing about the discrepancy between their own self-image and what others think of them."
      },
      {
        "id": "D",
        "text": "Although people appreciate the value of being truthful, they are generally unwilling to point out others failings."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "The view could be true of Grande Terre's stick insects but is not true of the island's flea beetles."
      },
      {
        "id": "B",
        "text": "The view has some empirical support but is weakened by the findings of Buckley et al."
      },
      {
        "id": "C",
        "text": "The view suggests that Grande Terre may have emerged as early as 41.1 million years ago."
      },
      {
        "id": "D",
        "text": "The view depends on inaccurate assumptions about the crown ages of the clades of stick insects and flea beetles on Grande Terre."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Its frequency in Classical Nahuatl poetry confirms its intelligibility to the Aztec audience."
      },
      {
        "id": "B",
        "text": "Its unintelligibility may cause its formal function within a line of verse to go unnoticed by present-day readers."
      },
      {
        "id": "C",
        "text": "Its apparent obscurity can be resolved when considered in the proper cultural context."
      },
      {
        "id": "D",
        "text": "Its metaphorical significance derives from the semantic equivalence of the two nouns constituting the difrasismo."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "biophilic design considerations are exercised during both the conception and execution of a new project."
      },
      {
        "id": "B",
        "text": "architecture firms like Young Projects typically work with large crews in order to expedite the time it takes to build a new project."
      },
      {
        "id": "C",
        "text": "architecture firms like Young Projects aim to use unique building materials for each project that they design."
      },
      {
        "id": "D",
        "text": "biophilic design prioritizes the emotional effects on inhabitants rather than the physical state of the natural surroundings."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "despite the greater prevalence of anterior genes in sea stars' genetic makeup, posterior genes active at the body's perimeter are primarily responsible for the starlike layout that distinguishes sea stars' radial symmetry from that of other echinoderms."
      },
      {
        "id": "B",
        "text": "although the two species are closely related, there is only minimal correspondence in the genetic markers for head, tail, and trunk region development in *P. miniata* sea stars and *S. kowalevskii* acorn worms."
      },
      {
        "id": "C",
        "text": "rather than undergoing changes resulting in the eventual elimination of a head region in their radial body plan, as previously assumed, sea stars' morphology evolved to completely lack a trunk and consist primarily of a head region."
      },
      {
        "id": "D",
        "text": "contrary to the belief that they evolved from early ancestors with the bilateral form typical of many other animals, sea stars instead originated with an atypical body layout that was neither bilaterally nor radially symmetrical."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Both EPDM rubber and single-ply NiTi wire fibers heat up when twisted, according to a 2019 study."
      },
      {
        "id": "B",
        "text": "Researchers determined that when the fibers were twisted, the average surface temperature of single-ply NiTi wire increased more than that of EPDM rubber."
      },
      {
        "id": "C",
        "text": "In 2019, two research teams observed the effects of torsional heating on various fibers, including EPDM rubber and single-ply NiTi wire."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Merle Oberon was famous for her roles in films like *Strange Evidence* (1933) and *The Price of Fear* (1956)."
      },
      {
        "id": "B",
        "text": "*Strange Evidence* (1933) was released early in Merle Oberon's career, whereas *The Price of Fear* (1956) came out years later."
      },
      {
        "id": "C",
        "text": "In *Strange Evidence* (1933), actress Merle Oberon played a nameless, uncredited role; however, in *The Price of Fear* (1956), she played a credited role-that of Jessica Warren."
      },
      {
        "id": "D",
        "text": "Early in her career, Merle Oberon wasn't listed in some film credits, such as the credits for the film *Strange Evidence*, where she played a nameless, uncredited role."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Relief printing is intaglio's reverse: the ink is applied not to the carved grooves of the printing block but to its raised, uncarved portions."
      },
      {
        "id": "B",
        "text": "Relief printing, rather than intaglio, is the technique Doi used to depict boats approaching a dock in the 1935 work *Sheepshead Bay*."
      },
      {
        "id": "C",
        "text": "In contrast to relief printing, in which ink is applied to the uncarved portions of the block, intaglio printing uses the printing block to stamp the image onto paper."
      },
      {
        "id": "D",
        "text": "In both relief printing and intaglio, an image is carved onto a printing block leaving grooves onto which ink is applied."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
