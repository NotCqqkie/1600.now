...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Waterbird communities at Back River, a site with a relatively high percentage of developed land and a relatively low percentage of hardened shoreline, had higher average IWCI scores than did waterbird communities at Margothy, a site with a lower percentage of developed land but a higher percentage of hardened shoreline."
      },
      {
        "id": "B",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Hernandez-Lopez a lawyer and cycling advocate"
      },
      {
        "id": "B",
        "text": "Hernandez-Lopez, a lawyer and cycling advocate,"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "The Carnegie Art Museum in Pittsburgh, Pennsylvania, has awarded Carnegie Prize gold medals to both painters and sculptors."
      },
      {
        "id": "D",
