...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "To show that attitudes toward the petition within the tribal community change over time"
      },
      {
        "id": "B",
        "text": "To demonstrate that most tribal members are enthusiastic about signing the petition"
      },
      {
        "id": "C",
        "text": "To portray Louis Pipe stone's strong commitment to collecting signatures for the petition"
      },
      {
        "id": "D",
        "text": "To suggest that some tribal members refuse to sign the petition because they dislike Louis Pipe stone"
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It explains where the language discussed in the text is from."
      },
      {
        "id": "B",
        "text": "It provides English translations of the Nuxalk words discussed in the text."
      },
      {
        "id": "C",
        "text": "It contrasts the language discussed in the text with other languages."
      },
      {
        "id": "D",
        "text": "It provides a general definition of the phenomenon discussed in the text."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "They can be used to contain microplastics within certain areas of the ocean."
      },
      {
        "id": "B",
        "text": "They are mainly composed of water."
      },
      {
        "id": "C",
        "text": "They have a much stronger effect on wave activity than microplastics alone do."
      },
      {
        "id": "D",
        "text": "They are helpful for removing microplastics from the ocean."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Continued research and development in artificial-leaf technology is needed before the devices can be widely used as an energy source."
      },
      {
        "id": "B",
        "text": "The recent increase in the commercial use of artificial leaves as an energy source has encouraged many scientists to research ways to improve the technology."
      },
      {
        "id": "C",
        "text": "Artificial leaves were developed to mimic the natural process of photosynthesis in plants in order to store energy for long-term commercial use."
      },
      {
        "id": "D",
        "text": "Artificial leaves split water molecules into oxygen and hydrogen gas using catalysts more efficiently than plants dousing the process of photosynthesis."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "10,864 square miles"
      },
      {
        "id": "B",
        "text": "2,533 square miles"
      },
      {
        "id": "C",
        "text": "4,453 square miles"
      },
      {
        "id": "D",
        "text": "2,188 square miles"
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Italy reported 57 damaging fungus species and 42 damaging insect species, while both Poland and Finland reported more insect species than fungus species."
      },
      {
        "id": "B",
        "text": "Poland reported 105 damaging insect species, which is more than either Italy or Finland reported."
      },
      {
        "id": "C",
        "text": "Italy reported 57 damaging fungus species, which is more than either Poland or Finland reported."
      },
      {
        "id": "D",
        "text": "Italy and Finland reported 14 and 6 damaging insect species, respectively, which is far fewer than Poland reported."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "The prevention of soil erosion was ranked higher for the general public than was the provision of medicinal plants."
      },
      {
        "id": "B",
        "text": "The provision of medicinal plants was ranked higher for the general public than were the other four services."
      },
      {
        "id": "C",
        "text": "The provision of medicinal plants was ranked higher for stakeholders than it was for the general public."
      },
      {
        "id": "D",
        "text": "The enhancement of pollination was ranked lower for the general public than it was for project leaders."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "None of the species that emitted sounds did so before the simulated attacks, and nearly all stopped emitting sounds within ten seconds after the attacks."
      },
      {
        "id": "B",
      ...
      {
        "id": "C",
        "text": "Caterpillar clicks were emitted in a frequency detectable by birds that prey on caterpillars, but caterpillar vocalizations were not."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "There are geographic differences in primary language within China that are reflected in the settlement patterns of Chinese immigrants in New York City."
      },
      {
        "id": "C",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Identifiable by its very long, black, curved bill and its bronzy back, the great-billed hermit is a large hummingbird found in Suriname."
      },
      {
        "id": "B",
        "text": "One way to distinguish the great-billed hermit from the amethyst woodstar is to look at their bills: the great-billed hermit's is curved, whereas the amethyst woodstar's is straight."
      },
      {
        "id": "C",
        "text": "The great-billed hermit and the amethyst woodstar are two of the thirty-five different hummingbird species found in Suriname."
      },
      {
        "id": "D",
        "text": "The amethyst woodstar is a small hummingbird identifiable by its green back and its short, black, straight bill."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "The second and fourth months of the Gregorian calendar are February and April, respectively."
      },
      {
        "id": "C",
        "text": "The timelines for the months of the two calendars don't match; for example, the sixth month of the French Republican calendar begins during the second month of the Gregorian calendar."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Based on their Mohs scale numbers, diamond (10) is harder than quartz (7), and quartz is harder than fluorite (4)."
      },
      {
        "id": "B",
        "text": "A mineral with a Mohs number of 10, like diamond, is harder than one with a Mohs number of 7, like quartz."
      },
      {
        "id": "C",
        "text": "The Mohs scale of mineral hardness can be used to order quartz, fluorite, and diamond by their ability to scratch other minerals."
      },
      {
        "id": "D",
        "text": "Diamond can leave visible scratches on fluorite, which is why diamond has a higher number than fluorite on the Mohs scale of mineral hardness."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
