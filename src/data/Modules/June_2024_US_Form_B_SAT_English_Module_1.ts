...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "It provides English translations of the Nimipuutimt words discussed in the text."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "It hints at how the insufficient distribution of lights in the rectory could be fixed."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Even though the study found that parks in Fortaleza are more likely to be close to other amenities than parks in Quito are, Quito has more amenities overall than Fortaleza does."
      },
      {
        "id": "B",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "Although people wish to be thought of as generous, the smallest impediments will often deter them from being so."
      },
      {
        "id": "C",
        "text": "Although people recognize why being direct is important, they usually avoid openly criticizing others for their shortcomings."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "analyze musical similarities in the songs of the Warlpiri and Temiar people."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "adjusted the volume of the nature sounds to be greater than 60.8 decibels."
      },
      {
        "id": "C",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "In terms of area, the El Carmen-Verde Mountains (which cover 1,141 mi 2) are larger than the Sierrita Mountains (63 mi 2)."
      },
      {
        "id": "C",
      ...
      {
        "id": "D",
        "text": "The El Carmen-Verde Mountains and the Sierrita Mountains are both isolated mountain ranges whose environments differ drastically from that of the surrounding lowlands."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
