...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It presents examples to support a claim made earlier in the text."
      },
      {
        "id": "B",
        "text": "It shows how two artists benefited from ignoring certain conventions."
      },
      {
        "id": "C",
        "text": "It proposes a reason why one work of art is widely thought to be more successful than another."
      },
      {
        "id": "D",
        "text": "It undermines an assertion made later in the text."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "All the pieces of graphene collected on just one of the two surfaces."
      },
      {
        "id": "B",
        "text": "The low amount of friction between the surfaces became even lower."
      },
      {
        "id": "C",
        "text": "Carbon nanotubes on the surfaces fractured into smaller pieces."
      },
      {
        "id": "D",
        "text": "Friction between the surfaces did not noticeably change right away."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Although people grasp the importance of honesty, they typically resist confronting others about their flaws."
      },
      {
        "id": "B",
        "text": "Although people wish to be seen as considerate, the slightest setbacks will often discourage them from being so."
      },
      {
        "id": "C",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "the average monthly low temperature was higher in June than in May."
      },
      {
        "id": "B",
        "text": "the average male wing centroid size was larger in July than in October."
      },
      {
        "id": "C",
        "text": "the average female wing centroid size was 2.02 mm in July but was 2.31 mm in June."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "the number of finches building nests near the road will gradually increase as the finches adapt to the presence of the common ravens."
      },
      {
        "id": "C",
        "text": "finches nesting near the road will lose eggs to common ravens at a higher rate than will finches nesting far from the road."
      },
      {
        "id": "D",
        "text": "finches nesting far from the road will lay fewer eggs per nest than will finches nesting near the road."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "affecting the results for both tucos and dark-eyed juncos."
      },
      {
        "id": "C",
        "text": "more suitable for studying dark-eyed juncos than for studying tucos."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "furnaces and stainless steel used to manufacture washing machines will both have a chromium content of less than 10.5%."
      },
      {
        "id": "B",
        "text": "washing machines will have a higher concentration of nickel in its composition than stainless steel used to manufacture furnaces will."
      },
      {
        "id": "C",
        "text": "induction cookers will have a face-centered cubic crystalline structure, but stainless steel used to manufacture storage containers will not."
      },
      {
        "id": "D",
        "text": "storage containers and stainless steel used to manufacture induction cookers will have a similar concentration of nitrogen in their compositions."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "Ur and Euramerica were both supercontinents, single landmasses made up of most or all of Earth's continents."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Modern-day Pueblo buildings, such as those in Zuni Pueblo and Isleta Pueblo, incorporate elements that wouldn't have been found in Square Tower House."
      },
      {
        "id": "B",
        "text": "The Ancestral Puebloan settlement of Square Tower House was built with adobe and stone, materials still used in the buildings of Zuni Pueblo and Isleta Pueblo."
      },
      {
        "id": "C",
        "text": "The elaborate buildings of Square Tower House in southwestern Colorado incorporate both traditional and modern-day elements in their design."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Mass fraction, mole fraction, and volume fraction can all be used to express an element's relative abundance in a given environment."
      },
      {
        "id": "B",
        "text": "Expressed as a mass fraction, the relative abundance of potassium on Earth is 160 ppm, or 0.016%."
      },
      {
        "id": "C",
        "text": "The relative abundance of the element potassium on Earth can be expressed in three different ways."
      },
      {
        "id": "D",
        "text": "On Earth, the mass fraction of potassium is greater than that of calcium."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
