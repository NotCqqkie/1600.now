...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "To convey that crowded areas can cause people to experience feelings of sadness"
      },
      {
        "id": "B",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "It adopted Nahuatl and Taino words in approximately equal numbers."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Even though the study found that parks in Fortaleza are more likely to be close to other amenities than parks in Panama City are, Panama City has more amenities overall than Fortaleza does."
      },
      {
        "id": "B",
        "text": "The study's findings suggest that an increase in the number of amenities near city parks would likely increase park use in Panama City but not in Fortaleza."
      },
      {
        "id": "C",
        "text": "The study's finding that a greater proportion of residents use parks in Panama City than in Fortaleza is partly due to the greater prevalence of parks in Panama City."
      },
      {
        "id": "D",
        "text": "Although the study found that a greater proportion of residents use parks in Panama City than in Fortaleza, that difference isn't due to greater access to amenities near parks in Panama City."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "the opening weekend earnings for *Instructions Not Included* were $7,846,426 and $904,998 for *The Girl Who Played with Fire*."
      },
      {
        "id": "B",
      ...
      {
        "id": "D",
        "text": "*All About My Mother* was recognized by the Oscars, but *Instructions Not Included*, which was not recognized, had higher lifetime earnings."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Hikers aiming to count themselves among the 50 Completers must reach not only West Virginia's Spruce Knob but also the even higher peak of Mount Elbert Colorado."
      },
      {
        "id": "B",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "Raj Reddy won the A.M. Turing Award in 1994; Manuel Blum won it later, in 1995."
      },
      {
        "id": "C",
        "text": "In 1995, Manuel Blum won the A.M. Turing Award for contributions to the foundations of computational complexity theory."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Catherine A. Moore's career as a lighthouse keeper ended in 1878, whereas Laura J. Hecox's ended in 1917."
      },
      {
        "id": "B",
        "text": "Laura J. Hecox began her career as a lighthouse keeper years after Catherine A. Moore did."
      },
      {
        "id": "C",
        "text": "From 1817 to 1878, the nighttime waters of Connecticut were more navigable thanks to lighthouse keepers Laura J. Hecox and Catherine A. Moore."
      },
      {
        "id": "D",
        "text": "Before automation, lighthouse keepers like Catherine A. Moore and Laura J. Hecox were crucial to ensuring safe navigation for watercraft."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
