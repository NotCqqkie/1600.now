...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "It argues that octopuses use tools more often than other animals do."
      },
      {
        "id": "C",
      ...
      {
        "id": "D",
        "text": "It emphasizes that octopuses are smarter than birds."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "individual French bulldogs likely display higher levels of chasing than individual bullmastiffs."
      },
      {
        "id": "C",
        "text": "French bulldogs and bullmastiffs show a greater tendency toward chasing than most other dog breeds do."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "include gold jewelry."
      },
      {
        "id": "B",
        "text": "result from artifacts being unearthed accidentally."
      },
      {
        "id": "C",
        "text": "include rare items from the 10th century BCE."
      },
      {
        "id": "D",
        "text": "occur before the ground was disturbed."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "the state was previously home to some walnut twig beetles but they were out competed by invading species."
      },
      {
        "id": "B",
        "text": "It's useful at present for the state to distinguish between invasive and native species in some instances but not in the case of the walnut twig beetle."
      },
      {
        "id": "C",
        "text": "even if Earth's climate doesn't change in the way scientists predict, the walnut twig beetle will likely establish itself in the state."
      },
      {
        "id": "D",
        "text": "the state's designation of the walnut twig beetle as invasive may be appropriate now but not in the future."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Crustaceans called *Artemia franciscana* and bacteria called *Nodularia* both live in the southern portion of the Great Salt Lake."
      },
      {
        "id": "B",
        "text": "Bacteria called *Nodularia* live in the Great Salt Lake, which is located in Utah."
      },
      {
        "id": "C",
