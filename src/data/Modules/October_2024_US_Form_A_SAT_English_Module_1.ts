...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "The text lists the authors of a collection of essays and then notes that some of the essays were written by one person, while others were written by two people."
      },
      {
        "id": "B",
        "text": "The text describes why a collection of essays is notable and then details its publication history."
      },
      {
        "id": "C",
        "text": "The text summarizes an argument made in a collection of essays and then suggests that the essays' authors didn't unanimously agree with the argument."
      },
      {
        "id": "D",
        "text": "The text mentions a collection of essays and then points out something about these essays that is not completely known."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Harris is worried that the captain will start to feel sick during this boat trip."
      },
      {
        "id": "B",
        "text": "Harris has a hard time remembering his first trip across the English Channel when his friends ask about it."
      },
      {
        "id": "C",
        "text": "When Harris speaks of an earlier trip, he often changes the details but always brags about his own wellness."
      },
      {
        "id": "D",
        "text": "Harris spent most of his time with a particular passenger during a previous boat trip."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It has borrowed words from Indigenous languages and contributed word to them."
      },
      {
        "id": "B",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Although the number of leaf pairs showing same-side orientation is fairly high in the July grape, it is much lower in both the Amur grape and graybark grape."
      },
      {
        "id": "B",
        "text": "In the graybark grape, Amur grape, and July grape, all the leaf pairs show opposite-side orientation."
      },
      {
        "id": "C",
        "text": "Although the exact ratio varies by species, the graybark grape, Amur grape, and July grape all show more leaf pairs with opposite-side orientations than with same-side orientations."
      },
      {
        "id": "D",
        "text": "The number of leaf pairs showing opposite-side orientation is fairly high in the July grape, but not as high as it is in the graybark grape."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "experienced the nature sounds as louder than \"Sad but True\" even though they were not."
      },
      {
        "id": "B",
        "text": "believed that neither the nature sounds nor \"Sad but True\" were at a volume of 61.5 decibels."
      },
      {
        "id": "C",
        "text": "perceived the nature sounds and \"Sad but True\" to be comparably meaningful despite perceiving the music to be quieter."
      },
      {
        "id": "D",
        "text": "adjusted the volume of the nature sounds to be greater than 61.5 decibels."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "the French bulldog and the cairn terrier differ with respect to the genetic underpinnings for attachment and attention-seeking."
      },
      {
        "id": "B",
        "text": "the French bulldog and the cairn terrier will likely become more genetically similar over time."
      },
      {
        "id": "C",
        "text": "French bulldogs and cairn terriers show a greater tendency toward attachment and attention-seeking than most other dog breeds do."
      },
      {
        "id": "D",
        "text": "individual French bulldogs may display higher levels of attachment and attention-seeking than individual cairn terriers."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "some genera of large-bodied moths may use ultrasonic signaling for purposes other than avoiding capture by predators such as the eastern red bat."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "cartographer Abraham Ortelius,"
      },
      {
        "id": "B",
        "text": "cartographer, Abraham Ortelius"
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "A public path created from a former railroad corridor can be found in Maine."
      },
      {
        "id": "B",
        "text": "Both the Simon Kenton Trail and the Papermill Trail are rail trails."
      },
      {
        "id": "C",
        "text": "The Simon Kenton Trail is in Ohio, whereas the Papermill Trail is in Maine."
      },
      {
        "id": "D",
        "text": "A former railroad corridor, the Simon Kenton Trail is located in Ohio."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "In Oahu, Hawaii, seeds from *Touchardia latifolia* and *Hedychium gardnerianum* plants were found in the fecal samples of non-native birds."
      },
      {
        "id": "B",
        "text": "The plants *Touchardia latifolia* and *Hedychium gardnerianum* can be found in Oahu, Hawaii."
      },
      {
        "id": "C",
        "text": "*Touchardia latifolia*, a species of shrub, is native to Oahu, Hawaii, but *Hedychium gardnerianum*, a species of vine, is not."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Elizabeth Lusby and Thelma Austin both played crucial roles in ensuring safe navigation for watercraft in past centuries."
      },
      {
        "id": "B",
      ...
      {
        "id": "C",
        "text": "Elizabeth Lusby worked as a lighthouse keeper in an earlier century than did Thelma Austin."
      },
      {
        "id": "D",
        "text": "From 1844 to 1862, the nighttime waters of Maryland were made more navigable thanks to Elizabeth Lusby."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
