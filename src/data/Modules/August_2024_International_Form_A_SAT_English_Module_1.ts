...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It emphasizes that Brown's life has been a popular subject for writers because it was so remarkable."
      },
      {
        "id": "B",
        "text": "It suggests that other people who are familiar with Brown's life would share the author's view of her."
      },
      {
        "id": "C",
        "text": "It explains why Brown was unique amongst her peers."
      },
      {
        "id": "D",
        "text": "It describes the nature of the relationship between Yung and Brown."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It explains what can be gained from a scientific approach to understanding natural phenomena."
      },
      {
        "id": "B",
        "text": "It describes an intensely debated scientific controversy that Victor dedicated his life to resolving."
      },
      {
        "id": "C",
        "text": "It undermines the idea that a practical approach to understanding natural phenomena is inferior to a scientific approach."
      },
      {
        "id": "D",
        "text": "It suggests that Victor did not discover what he wanted to know from the scientific research available to him."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "Black journalists has an interesting history both inside and outside the United States."
      },
      {
        "id": "C",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "Researchers are uncertain why relatively small cats, such as ocelots, purr but relatively large cats, such as jaguars, roar."
      },
      {
        "id": "C",
        "text": "Jaguars and most other species of big cats can roar because they have flexible hyoid bones that are attached by stretchy ligaments to their skulls."
      },
      {
        "id": "D",
        "text": "Differences related to the hyoid bone in ocelots and jaguars may help explain why one species purrs and the other roars."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "When borrowing from Indigenous languages, Spanish adopted roughly as many words from Nahuatl as from Quechua."
      },
      {
        "id": "C",
        "text": "Many Spanish words with Indigenous origins first passed through English before entering Spanish."
      },
      {
        "id": "D",
        "text": "When non-Indigenous languages borrowed from Indigenous languages, the words often underwent a significant change in meaning."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "Both the song in Luk Saami and the song in Tundra Nenets were sung by a female singer."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "*M. knippeliana* may have been overlooked in eastern and western Coahuila because of its similarity to another species."
      },
      {
        "id": "B",
        "text": "the current methods of collecting and tracking *Mammillaria* species throughout Mexico may cause an overestimation of the number of species in this genus."
      },
      {
        "id": "C",
        "text": "the perceived absence of *Mammillaria* in eastern and western Coahuila may be due to insufficient exploration of the region."
      },
      {
        "id": "D",
        "text": "the dense vegetation and high annual precipitation levels in eastern and western Coahuila impede the ability of *Mammillaria* species to survive."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "artists Thomas Hart Benton, and Jackson Pollack,"
      },
      {
        "id": "B",
        "text": "artists: Thomas Hart Benton and Jackson Pollack,"
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "In Puerto Rico, the genus *Hemisotoma* contains one springtail species, and the genus *Sphaeridia*."
      },
      {
        "id": "B",
      ...
      {
        "id": "D",
        "text": "There are 146 species of springtail (noninsect hexapods) in Puerto Rico, but there are more species from the genus *Sphaeridia* than from the genus *Hemisotoma*."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "There were a total of 1,236 ships hired to carry cargo or passengers registered in Greece in 2021."
      },
      {
        "id": "B",
        "text": "The carrying capacity of bulk carriers, cruise liners, and oil tankers is measured in deadweight tonnage."
      },
      {
        "id": "C",
        "text": "A merchant vessel is any ship hired to carry cargo or passengers like bulk carriers, cruise liners, and oil tankers."
      },
      {
        "id": "D",
        "text": "In total, Greece's 1,236 merchant vessels had a carrying capacity of 64.9 million tons in 2021."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "While both are protest songs, *Poor Miner's Farewell* is about coal miners in Kentucky, whereas *Bring Him Back Home* is about the anti-apartheid leader Nelson Mandela."
      },
      {
        "id": "B",
        "text": "Hugh Masekala's song *Bring Him Back Home*, released in 1987, called on the South African government to free Nelson Mandela."
      },
      {
        "id": "C",
        "text": "The songs *Poor Miner's Farewell* and *Bring Him Back Home* both raised awareness about human rights violations."
      },
      {
        "id": "D",
        "text": "Released in 1932 by Aunt Molly Jackson, the song *Poor Miner's Farewell* was a protest against the unlivable wages and dangerous working conditions faced by Kentucky coal miners."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
