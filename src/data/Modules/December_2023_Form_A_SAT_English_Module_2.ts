...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "controversial among"
      },
      {
        "id": "B",
        "text": "antagonistic toward"
      },
      {
        "id": "C",
        "text": "imitated by"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "Did Wahbi and colleagues study effectively exclude any nutrient pathway other than a CMN?"
      },
      {
        "id": "C",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "It represents changes to human experience brought about by technology."
      },
      {
        "id": "C",
        "text": "It is an aesthetic feature that has little or no social import."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Arizona pocket mice tend to be more active during periods of high lunar intensity than at other times because such conditions allow them to increase their foraging success without making them easier to detect."
      },
      {
        "id": "B",
        "text": "During periods of high lunar intensity, Arizona pocket mice reduce their activity because it is easier for predators to detect the mice in relatively bright conditions than it is for predators to detect three striped night monkeys in such conditions."
      },
      {
        "id": "C",
        "text": "Arizona pocket mice reduce their activity during periods of high lunar intensity because predators can more easily spot the mice in brighter conditions and such conditions do not benefit the mice enough to justify that risk."
      },
      {
        "id": "D",
        "text": "During periods of high lunar intensity three-striped night monkeys show a different behavioral response than Arizona pocket mice and many other nocturnal mammals do because the risks to three striped night monkeys under such conditions are greater."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "most lizard species use about the same percentage of their maximal speed when escaping predation as they do when pursuing prey."
      },
      {
        "id": "B",
        "text": "multiple lizard species move at an average of less than 90% of their maximal speed while escaping predation."
      },
      {
        "id": "C",
        "text": "more lizard species use, on average, 90% -100% of their maximal speed while escaping predation than use any other percentage of their maximal speed."
      },
      {
        "id": "D",
        "text": "at least 4 lizard species use, on average, less than 100% of their maximal speed while pursuing prey."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "attract glossy ibises to the area than they are to attract small white herons to the area."
      },
      {
        "id": "B",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "hormone levels were higher in wild males than in captive male canaries."
      },
      {
        "id": "B",
        "text": "wild males and captive males usually exhibited very similar hormone levels."
      },
      {
        "id": "C",
        "text": "significant differences in hormone levels between individuals were found for both wild males and captive males."
      },
      {
        "id": "D",
        "text": "levels of androgen hormones during breeding season the higher in wild males than they are in captive males."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "the topological tapestries of Argentine textile artist Alexandra Kehayoglou are"
      },
      {
        "id": "B",
        "text": "the Argentine textile artist Alexandra Kehayoglou creates topological tapestries that are"
      },
      {
        "id": "C",
        "text": "when she creates her topological tapestries. Argentine textile artist Alexandra Kehayoglou makes them"
      },
      {
        "id": "D",
        "text": "Alexandra Kehayoglou is an Argentine textile artist whose topological tapestries are"
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "fertilizers, which contain"
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "Home to 40,583 people, the governmental region was responsible for providing water treatment to its population in 2010."
      },
      {
        "id": "C",
