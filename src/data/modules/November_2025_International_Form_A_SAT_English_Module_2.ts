...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "To suggest that Mexican American authors who were influenced by Garcia Marquez may have, in turn, influenced him."
      },
      {
        "id": "C",
        "text": "To refute the possible impression that Garcia Marquez conformed to magical realism in all of his works."
      },
      {
        "id": "D",
        "text": "To challenge the common assumption that *One Hundred Years of Solitude* is superior to realist works by Garcia Marquez."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "compounds, hexafluorobenzene (C 6 F 6) and benzene (C 6 H 6),"
      },
      {
        "id": "B",
        "text": "compounds hexafluorobenzene (C 6 F 6) and benzene (C 6 H 6),"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "On November 15, 2013, In Suk Han finally completed the feat of reaching the highest point in all fifty US states, including Spruce Knob in West Virginia and Mount Elbert in."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "Born in 1644, Antonio Stradivari was an ltalian instrument maker whose violins are famous for their quality."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
