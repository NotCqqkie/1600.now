...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "To argue that wooden shipwrecks affect fish more than they do microbial communities"
      },
      {
        "id": "B",
        "text": "To describe how the first shipwreck in the Gulf of Mexico was discovered"
      },
      {
        "id": "C",
        "text": "To detail the composition of the HMS *Conqueror*"
      },
      {
        "id": "D",
        "text": "To provide an overview of a study about the effects of wooden shipwrecks on seafloor microbial communities"
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "It includes exhibits on several important American writers."
      },
      {
        "id": "D",
        "text": "It is near other museums dedicated to local history."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Chacana and Chimborazo are both shield volcanoes."
      },
      {
        "id": "B",
        "text": "Different volcano types have different years of last eruption."
      },
      {
        "id": "C",
        "text": "Fernandina is the only shield volcano among the four Ecuadoran volcanoes shown in the table."
      },
      {
        "id": "D",
        "text": "None of the four Ecuadoran volcanoes shown in the table are shield volcanoes."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "1,600,000 units sold compared to the approximately 18,450,000 units sold of the Atari 2600."
      },
      {
        "id": "B",
        "text": "3,935,000 units sold compared to the approximately 4,487,000 units sold of the Apple II."
      },
      {
        "id": "C",
        "text": "3,935,000 units sold compared to the approximately 4,487,000 units sold of the Atari 2600."
      },
      {
        "id": "D",
        "text": "1,600,000 units sold compared to the approximately 18,450,000 units sold of the Sega SG-1000/Master System."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "*S. rosetta* tended to form colonies when exposed to *S. ruber*, but not when exposed to *C. crescentus*."
      },
      {
        "id": "B",
        "text": "*S. rosetta* tended to form colonies when exposed to *C. crescentus*, but not when exposed to *S. ruber*."
      },
      {
        "id": "C",
        "text": "*S. rosetta* did not tend to form colonies when exposed to either *C. crescentus* or *S. ruber*."
      },
      {
        "id": "D",
        "text": "*S. rosetta* tended to form colonies when exposed to *C. crescentus* and when exposed to *S. ruber*."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "aerospace tubing will have similar magnetic properties to stainless steel used to manufacture induction cookers."
      },
      {
        "id": "B",
        "text": "both aerospace tubing and dishwashers will have a face-centered cubic crystalline structure, but stainless steel used to manufacture aerospace tubing will have less nickel than stainless steel used to manufacture dishwashers will"
      },
      {
        "id": "C",
        "text": "aerospace tubing will have a concentration of manganese greater than 10.5%, while stainless steel used to manufacture dishwashers will not."
      },
      {
        "id": "D",
        "text": "aerospace tubing will have less manganese in its composition than stainless steel used to manufacture dishwashers will."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "come to be known as the Reconstruction era?"
      },
      {
        "id": "B",
        "text": "come to be known as the Reconstruction era."
      ...
      {
        "id": "C",
        "text": "it come to be known as the Reconstruction era."
      },
      {
        "id": "D",
        "text": "it come to be known as the Reconstruction era?"
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "have encouraged"
      },
      {
        "id": "C",
        "text": "are encouraging"
      },
      {
        "id": "D",
        "text": "encourage"
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "length, (62 km); slip rate, (between 0.2 and 1.0 mm/yr);"
      },
      {
        "id": "B",
        "text": "length, (62 km), slip rate, (between 0.2 and 1.0 mm/yr),"
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "The Isthmus of Ierapetra is an isthmus, or land bridge."
      },
      {
        "id": "B",
        "text": "The Isthmus of Panama is located in Central America, while the Isthmus of Ierapetra is located in the Mediterranean Sea."
      },
      {
        "id": "C",
        "text": "There is an isthmus, or land bridge, located in Central America."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "The Columbia Trail is in New Jersey, whereas the Flint Hills Trail is in Kansas."
      },
      {
        "id": "B",
        "text": "A former railroad corridor, the Columbia Trail is located in New Jersey."
      },
      {
        "id": "C",
        "text": "Both the Columbia Trail and the Flint Hills Trail are rail trails."
      },
      {
        "id": "D",
        "text": "A public path created from a former railroad corridor can be found in Kansas."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "In 2019, American author Ocean Vuong published a novel of letters sent from a young man named Little Dog to his mother, Rose."
      },
      {
        "id": "B",
      ...
      {
        "id": "D",
        "text": "An epistolary novel is a novel written primarily as a series of fictional documents, such as letters, journal entries, or newspaper clippings."
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
