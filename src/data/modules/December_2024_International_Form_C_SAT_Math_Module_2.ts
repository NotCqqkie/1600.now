...
export const questions: Question[] = [
  {
    ...
    "text": "Levi and Marissa each have stamp collections. The number of stamps in Levi's collection is 200% of the number of stamps in Marissa's collection. If there are 460 stamps in Marissa's collection, how many stamps are in Levi's collection?",
    "choices": [
      {
        "id": "A",
        "text": "230"
  ...
  },
  {
    ...
    "testName": "December 2024 International Form C SAT Math Module 2",
    "text": "The graph of a system of a linear equation and a quadratic equation is shown. Which of the following is a solution (x, y) to the system?",
    "choices": [
      {
        "id": "A",
        "text": "(-1,5)"
  ...
  },
  {
    ...
    "testName": "December 2024 International Form C SAT Math Module 2",
    "text": "Which expression is equivalent to 158 $t^{3}$ -24 $t^{2}$ u?",
    "choices": [
      {
        "id": "A",
        "text": "$2t^{2}(79t^{2}-12u)$"
  ...
  },
  {
    ...
    "testName": "December 2024 International Form C SAT Math Module 2",
    "text": "Which expression is equivalent to $2(x-\\frac{3}{2})(x+14)$?",
    "choices": [
      {
        "id": "A",
        "text": "$x^{2}+25x-21$"
  ...
  },
  {
    ...
    "testName": "December 2024 International Form C SAT Math Module 2",
    "text": "The function f is defined by f (x)=(-7)(4) x + 31. What is the y -intercept of the graph of y=f(x) in the xy -plane?",
    "choices": [
      {
        "id": "A",
        "text": "(0,24)"
  ...
  },
  {
    ...
    "testName": "December 2024 International Form C SAT Math Module 2",
    "text": "In right triangle RST, the sum of the measures of angle R and angle S is 90 degrees. The value of sin(R) is $\\frac{2\\sqrt{10}}{7}$. what is the value of cos(S)?",
    "choices": [
      {
        "id": "A",
  ...
  },
  {
    ...
    "testName": "December 2024 International Form C SAT Math Module 2",
    "text": "In the xy-plane, an equation of circle A is (x - 2) 2 + (y- 3) 2 = 9. Circle B has the same center as circle A but has a radius that is twice the radius of circle A. Which equation represents circle B?",
    "choices": [
      {
        "id": "A",
        "text": "$(x-2)^{2}+(y-3)^{2}=18$"
  ...
  },
  {
    ...
    "testName": "December 2024 International Form C SAT Math Module 2",
    "text": "The equation N(m) = $65(Q)^{\\frac{m}{4}}$ gives the predicted population N(m), in thousands, of a certain bacteria colony m minutes after the initial measurement, where Q is a constant greater than 1. The predicted population increases by p% every 120 seconds. what is the value of p in terms of Q?",
    "choices": [
      {
        "id": "A",
        "text": "$100(Q^{\\frac{3}{2}}+1)$"
      },
      {
        "id": "B",
        "text": "$100(Q^{30}+1)$"
