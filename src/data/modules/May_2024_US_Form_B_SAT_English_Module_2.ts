...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "It challenges the widely held view that Stephen Graham Jones based *Mapping the Interior* on events in his own life."
      },
      {
        "id": "B",
      ...
      {
        "id": "C",
        "text": "It highlights the significance of the portrayal of Indigenous people in *Mapping the Interior*."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "By suggesting that those poets who publish in major poetry journals are most likely to be able to earn a living by writing poetry"
      },
      {
        "id": "B",
        "text": "By pointing out that people can gain experience writing poetry while also working full-time jobs"
      },
      {
        "id": "C",
        "text": "By mentioning that people often work full-time jobs in order to afford professional training in writing poetry"
      },
      {
        "id": "D",
        "text": "By indicating that those artists who specialize in more financially rewarding artistic forms are unlikely to also be successful as poets"
      }
    ],
    "correctAnswer": "B",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "B",
        "text": "Its collection includes over 8,500 objects."
      },
      {
        "id": "C",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "Although sonnet cycles generally present an overarching narrative structure, some of those narratives, such as the narrative in McKay's \"Cities,\" are more cohesive than others."
      },
      {
        "id": "D",
        "text": "Although the rigidity of the conventions of sonnet cycles discourages experimentation, sonnet cycles sometimes exhibit truly novel features, as exemplified by McKay's \"Cities\" and Spenser's *Amoretti*."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Cuicocha is a caldera volcano, and Alcedo is a stratovolcano."
      },
      {
        "id": "B",
      ...
      {
        "id": "C",
        "text": "Reventador is a caldera volcano, and Alcedo is a stratovolcano."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Consumers were more likely to purchase both products in pairs with similarity ratings comparable to those of liquid bleach and toilet cleaner than they were to purchase both products in pairs with similarity ratings comparable to those of juice and dried fruit."
      },
      {
        "id": "B",
        "text": "Products in pairs with high similarity ratings tended to be among the most expensive products in their categories, whereas products in pairs with low similarity ratings tended to be among the least expensive products in their categories."
      },
      {
        "id": "C",
        "text": "Pairs with high similarity ratings tended to be in categories in which there were relatively few competing products from other brands, whereas pairs with low similarity ratings tended to be in categories in which there were many competing products from other brands."
      },
      {
        "id": "D",
        "text": "The positive correlation between similarity ratings and cross-category purchasing was equally strong for pairs with low brand recognition and pairs with high brand recognition."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "C",
        "text": "not find it enjoyable to listen to any recordings at a volume as low as 85.5 decibels."
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "sinks will have similar magnetic properties to stainless steel used to manufacture induction cookers."
      },
      {
        "id": "B",
        "text": "storage containers will have a concentration of chromium lower than 10.5%, while stainless steel used to manufacture dishwashers will not."
      },
      {
        "id": "C",
        "text": "induction cookers will have a face-centered cubic crystalline structure."
      },
      {
        "id": "D",
        "text": "dishwashers will have a lower percentage of chromium in its composition than stainless steel used for induction cookers will."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "was her favorite book!"
      },
      {
        "id": "B",
        "text": "her favorite book was?"
      },
      {
        "id": "C",
        "text": "her favorite book was."
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Over time, many meanders have formed in the Araguaia River, a river in Brazil with high sinuosity."
      },
      {
        "id": "B",
        "text": "The meanders in the Araguaia River will change shape and shift downstream over time."
      },
      {
        "id": "C",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "One example of an isthmus is the Isthmus of Mansheya."
      },
      {
        "id": "B",
      ...
      {
        "id": "C",
        "text": "The Isthmus of Mansheya is located in Egypt, where it connects the island of Pharos to mainland Alexandria."
      },
      {
        "id": "D",
        "text": "An isthmus, or land bridge, like the Isthmus of Mansheya, connects two larger pieces of land."
      }
    ],
    "correctAnswer": "C",
    "type": "multiple-choice",
