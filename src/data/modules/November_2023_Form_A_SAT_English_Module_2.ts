...
export const questions: Question[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "To compare basketball with other sports."
      },
      {
        "id": "B",
        "text": "To provide details of how to play basketball."
      },
      {
        "id": "C",
        "text": "To state how players will be chosen for the basketball team."
      },
      {
        "id": "D",
        "text": "To explain why the narrator thinks she might make the basketball team."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Unlike primates, octopuses are exceptionally skillful at using different tools."
      },
      {
        "id": "B",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "the number of cars produced increased but the number of companies producing cars decreased."
      },
      {
        "id": "B",
        "text": "both the number of cars produced and the number of companies producing cars remained unchanged."
      },
      {
        "id": "C",
        "text": "the number of cars produced decreased but the number of companies producing cars remained unchanged."
      },
      {
        "id": "D",
        "text": "both the number of cars produced and the number of companies producing cars increased."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "Most people spend about three minutes viewing *The Card Game* at the museum and only about one minute viewing it online."
      },
      {
        "id": "B",
      ...
      {
        "id": "C",
        "text": "Most people who go to museums in Savannah are visiting from other places."
      },
      {
        "id": "D",
        "text": "More than one museum has works of art by Jacob Lawrence in its full collection."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "the measures aimed at protecting birds will likely also minimize most of the effects on arthropods."
      },
      {
        "id": "B",
        "text": "the severity of the effects of noise on different species of birds can differ significantly."
      },
      {
        "id": "C",
        "text": "the effects of noise on birds have been less extensively documented than the effects on arthropods have."
      },
      {
        "id": "D",
        "text": "the measures intended to protect birds can sometimes have adverse effects on arthropods."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "D",
        "text": "the *Caledonia* needed a crew larger than 875 people in order to operate efficiently."
      }
    ],
    "correctAnswer": "A",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "do they affect our weather."
      },
      {
        "id": "B",
        "text": "they do affect our weather."
      },
      {
        "id": "C",
        "text": "do they affect our weather?"
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "The mass of stars, like Proxima Centauri, can be described in units called solar masses."
      },
      {
        "id": "B",
        "text": "In astronomy, the mass of stars can be described in units called solar masses, and one solar mass is roughly equal to the mass of the Sun."
      },
      {
        "id": "C",
        "text": "The Sun is more massive than Proxima Centauri, which has a mass of 0.122 solar masses."
      },
      {
        "id": "D",
        "text": "With a mass of 2.063 solar masses, Sirius A is more massive than the Sun."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "A",
        "text": "A prime example of the slow TV genre can be seen in *All Aboard! The Sleigh Ride*, a 2-hour British TV documentary program documenting a sleigh ride along an arctic postal route."
      },
      {
        "id": "B",
        "text": "While *All Aboard! The Sleigh Ride* depicts a sleigh ride along an arctic postal route, *Monsen: Minutt for Minutt* depicts a hike from Stigstuv to Rauhelleren in Norway."
      },
      {
        "id": "C",
        "text": "Compared to the 5-hour-long *Monsen: Minutt for Minutt*, the slow TV program *All Aboard! The Sleigh Ride* is relatively short, at 2 hours."
      },
      {
        "id": "D",
        "text": "Documenting ordinary events in real time, *All Aboard! The Sleigh Ride* and *Monsen: Minutt for Minutt* are both documentary programs in the slow TV genre."
      }
    ],
    "correctAnswer": "D",
    "type": "multiple-choice",
